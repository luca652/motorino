...
Moped.create!(name: "Phantom Malaguti", color: "Black", description: "", n_of_passengers: 1, price: "100", user_id: 1, address: "Via XX Settembre 100 Genova Italy")
...
Moped.create!(name: "RX 50 Aprilia", color: "Blue and gray", description: "", n_of_passengers: 1, price: "90", user_id: 3, address: "Piazza Embriaci 1 Genova Italy")
...
Moped.create!(name: "Lambretta SX200", color: "Silver", description: "", n_of_passengers: 2, price: "120", user_id: 6, address: "138 Kingsland Rd London E2 8DY")
Moped.create!(name: "Vintage 1964 Vespa", color: "Blue", description: "", n_of_passengers: 2, price: "120", user_id: 6, address: "Craven Road 7 London")
Moped.create!(name: "Lambretta SX200", color: "Silver", description: "", n_of_passengers: 2, price: "120", user_id: 6, address: "138 Kingsland Rd London E2 8DY")
Moped.create!(name: "Vintage 1961 Lambretta", color: "Black", description: "", n_of_passengers: 2, price: "120", user_id: 6, address: "12 Lewisham Way London")
