...
lambretta200 = Moped.create!(name: "Lambretta SX200", color: "Blue", description: "*", image_url: "mopeds/lambretta-blue.png", n_of_passengers: 2, price: "120", user_id: user6.id, address: "138 Kingsland Rd London E2 8DY")
lambretta61 = Moped.create!(name: "Vintage 1961 Lambretta", color: "White", description: "*", image_url: "mopeds/lambretta.png", n_of_passengers: 2, price: "120", user_id: user6.id, address: "12 Lewisham Way London")
